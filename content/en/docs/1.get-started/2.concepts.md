...
A trigger defines when a workflow starts on its own. Knecht reacts to GitHub events such as a new issue or a label, to changes in a connected [issue tracker](/docs/usage/triggers#trigger-types), and to a schedule. Any workflow can also be started by hand. One workflow can serve several projects.
...
![The project page with a succeeded run, the live preview in the middle, the follow-up chat below it, and the sessions and automation panels on the right](/assets/knecht-run.png)
