...
Knecht taking the issue itself does not fire "Assigned to Knecht". Labels and statuses the agent sets fire triggers as usual, and the condition "Assignee is Knecht" holds while Knecht works on the issue. Plane, where a work item takes several assignees, differs a little, see [Plane](/docs/integrations/plane#knecht-holds-the-work-item).
