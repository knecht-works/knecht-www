...
In return, we want one person who really uses Knecht and tells us regularly where it blocks them, what is missing, and what works well. We do not ask for more. This feedback from real projects is worth more to us than any local test.

## Who is a good fit

Knecht helps most where many projects need maintenance. You are a good fit if you work with DDEV and maintain enough projects that security updates and bug fixes are routine work for you. If your projects do not run on DDEV yet, but you can convert them with little effort, that also works.
